...
var futoin_hkdf_1 = require("futoin-hkdf");
...
exports.decryptMedia = function (message, useragentOverride) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ua = useragentOverride || "WhatsApp/2.16.352 Mozilla/5.0 (Macintosh; Intel Mac OS X 10.14; rv:72.0) Gecko/20100101 Firefox/72.0";
                ...
                _a.label = 1;
            case 1:
                if (!haventGottenImageYet) return [3 /*break*/, 6];
            ...
            case 2:
                ...
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, timeout(2000)];
            case 4:
                _a.sent();
                _a.label = 5;
            ...
            case 6:
                ...
                return [2 /*return*/, mediaDataBuffer];
        }
    });
}); };
