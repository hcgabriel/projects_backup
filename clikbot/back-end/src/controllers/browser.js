...
function initWhatsapp(sessionId, puppeteerConfigOverride, customUserAgent) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, initBrowser(sessionId, puppeteerConfigOverride)];
                case 1:
                    browser = _a.sent();
                    return [4 /*yield*/, getWhatsappPage(browser)];
                case 2:
                    waPage = _a.sent();
                    return [4 /*yield*/, waPage.setUserAgent(customUserAgent || puppeteer_config_1.useragent)];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, waPage.setViewport({
                ...
                case 4:
                    ...
                    return [4 /*yield*/, waPage.setCacheEnabled(cacheEnabled)];
                case 5:
                    _a.sent();
                ...
                case 6:
                    ...
                    sessionjson = puppeteerConfigOverride === null || puppeteerConfigOverride === void 0 ? void 0 : puppeteerConfigOverride.sessionData;
                    if (fs.existsSync(sessionjsonpath))
                        sessionjson = JSON.parse(fs.readFileSync(sessionjsonpath));
                    if (!sessionjson) return [3 /*break*/, 8];
                ...
                case 7:
                    _a.sent();
                    _a.label = 8;
                case 8: return [4 /*yield*/, waPage.goto(puppeteer_config_1.puppeteerConfig.whatsappUrl)];
                case 9:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, puppeteer.launch(__assign({ headless: true, devtools: false, 
                            // executablePath: '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome',
                            // userDataDir: path.join(process.cwd(), sessionId || 'session'),
                            args: __spreadArrays(puppeteer_config_1.puppeteerConfig.chromiumArgs) }, puppeteerConfigOverride))];
                case 1:
                    browser = _a.sent();
                    //devtools
